...
class CircleDetection:
    ...
    def find_circle_otsu(self, image_normed):
        ...
        # **************************************************
        # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Normalized_image.png',image_normed)
        # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Blurred_image.png',temp)
        kernel = np.ones((2, 2), dtype=np.uint8)
        erode = cv2.erode(temp, kernel, iterations=1)
       
        # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Eroded_image.png',erode)
        ret,th1 = cv2.threshold(
            erode, 0, 255, cv2.THRESH_BINARY+cv2.THRESH_OTSU)
        # hist,bins = np.histogram(erode,256,[0,256])
        # plt.xlabel('Color intensity')
        # plt.ylabel('Number of pixels')
        # plt.axvline(ret, color='r')
        # plt.hist(erode.ravel(),256,[0,256])
        # plt.show()
        
        # hist,bins = np.histogram(th1,256,[0,256])
        # plt.xlabel('Color intensity')
        # plt.ylabel('Number of pixels')
        # plt.hist(th1.ravel(),bins = 256)
       
        # plt.show()
        th2 = cv2.threshold(
            erode, 0, 255, cv2.THRESH_BINARY_INV+cv2.THRESH_OTSU)[1]
        # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\First_threshold_image.png',th1)
        # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Second_threshold_image.png',th2)
        closingSize = 4
        ...
        # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Closed_image.png',th1)
        th1 = cv2.Canny(th1, 200, 250)
        # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Canny_edge_image.png',th1)
        # **************************************************
        #  Applýing connected components
        nb_components, output, stats, centroids = cv2.connectedComponentsWithStats(
            th1, connectivity=8)
        # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Connected_component_image.png',output)
        ...
        if max_size > area:
            ...
            mask = None
        # thresh_min = threshold_minimum(image_normed)
     
        # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Circle_detection_image.png',th1)   
    ...
    def convert_video_to_images(self):
        ...
        for path_avi in self.list_folder_messtag:
            ...
            for white in self.list_folder_messtag_weiss:
                ...
                # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Image_white.png',image_white)
                
            for black in self.list_folder_messtag_schwarz:
           
                cap_black = cv2.VideoCapture(black)
                success, image_black = cap_black.read()
                # cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Image_black.png',image_black)
            count = 0
            ...
            while success:
                ...
                cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\Raw_image{}.png'.format(count),image)   
                ...
                cv2.imwrite(r'C:\Users\JOHNYA\Desktop\python_files\images_for_presentation\image_cropped.png',image_normed)   
...
if __name__ == '__main__':
    ...
    # source = r'G:\.shortcut-targets-by-id\1Mu4lv_LWn6F08ie0hnbKRVze0TO-U0aJ\UnifudiOC\03_Dokumentation\1.3_Anprobe\CREA2022_024_CRIMI_Kas_BM31_666_TES_ohneEDTA\02_Mess_SML\2022_10_24_VRF_ex\\'
    counter = 1
